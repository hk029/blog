...
用excel打开看一下，怎么是乱码
![Alt text](./1461212650482.png)



没关系又是编码的问题，用可以修改编码的编辑器比如sublime打开一下，
![Alt text](./1461212709798.png)

保存编码为utf-8包含bom

![Alt text](./1461212779777.png)
